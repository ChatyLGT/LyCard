...
// Extraído de app/m/login/page.tsx (2026-09-19) — un page.tsx marcado
// "use client" de punta a punta no puede exportar `dynamic =
// "force-dynamic"` (Next.js lo ignora en archivos cliente), así que
// esta pantalla quedaba prerenderizada UNA vez en el build y servida
// igual siempre — el favicon dinámico del layout raíz, y en teoría
// cualquier otro dato server-side futuro, nunca se actualizaban acá.
// page.tsx pasa a ser un Server Component fino que sí puede declarar
// force-dynamic; este componente es el mismo formulario de siempre.
