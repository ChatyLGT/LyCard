...
export default async function PersonalCardPage({ searchParams }: { searchParams: Promise<{ saved?: string }> }) {
  ...
  return <MemberCardEditor card={card} kind="personal" saved={saved === "1"} />;
}
